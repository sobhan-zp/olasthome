...
<header id="top">
    ...
    <div class="row">
        ...
        <div class="header-content twelve columns">
            ...
            <h1 id="logo-text"><a href="index.php" title="">رویدادها</a></h1>
            <p id="intro">اخبار جدید سایت</p>
        ...
        <div class="row">
            ...
            <ul id="nav" class="nav">
             ...
             <li><a href="archives.html">Archives</a></li>
                ...
                <li><a href="link.php">درباره ما</a></li>
            </ul> <!-- end #nav -->
                ...
                foreach ($posts as $post) {
                    ...
                    <header class="entry-header">
                        ...
                        <h2 class="entry-title">
                            <h2><a href='index.php?id=<?php echo $post['post_id']; ?>'><?php echo $post['title']; ?></a>
                            </h2>
                        </h2>
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li><a href="#" title="" rel="category tag">In <a
                                                href='category.php?id=<?php echo $post['category_id']; ?>'><?php echo "<font color='green'>" . $post['name'] . "</font>"; ?></a>
                                </li>
                                <span class="meta-sep">&bull;</span>
                                <li><!-- Blogger user--></li>
                            </ul>
